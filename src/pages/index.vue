  ...
  const allOptions = [
    {
      ...
      children: [
        ...
        // {text: '短视频', value: '0013'}, {text: '美妆搭配', value: '0014'},
        // { text: '其他职业', value: '0015' },

        // {text: '摄影摄像', value: '0017'}, {text: '新媒体', value: '0018'}, {
        //   text: '直播',
        //   value: '0019'
        // }, {text: '就业指导', value: '0020'},
        // {text: '创业', value: '0021'}
      ],
    },
    {
    ...
    },
    {
      ...
      value: '003',
      children: [
        {text: '理论', value: '0031'}, {text: ' 普法', value: '0032'},
        {
        text: '行业',
        value: '0033',
      }, {text: '政策', value: '0034'},
      ...
      <div style="position: relative">
        ...
        <div class="box-border">
          <van-dropdown-menu ref="menuRef">
            <van-dropdown-item ref="addressRef" :title="qu">
              <van-cascader
            ...
            <van-dropdown-item ref="itemRef" :title="timeDay">
              <div class="day-box">
                <div
                  v-for="item in dayOptions" class="day-item" :class="[selDay.includes(item.value) ? 'sel-item' : '']"
