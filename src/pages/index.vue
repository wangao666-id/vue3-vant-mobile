...
const allOptions = [
  {
    ...
    children: [
      ...
      { text: '美妆美甲', value: '0016' }, { text: '办公技能', value: '0017' },
      { text: '面试技巧', value: '0018' },

      { text: '职场心理', value: '0019' }, { text: '语言', value: '0020' }, {
        text: '演讲',
        value: '0021'
  ...
  },
  {
    ...
    value: '003',
    children: [
      { text: '行业/行业讲座', value: '0031' }, { text: ' 政策/政策解读', value: '0032' },
      {
        text: '普法',
        value: '0033',
      },
    ...
    <div class="top-search">
      ...
      <div style="position: relative">
        <div style="background: white" class="flex">
          <van-search v-model.trim="searchValue" show-action shape="round" placeholder="请输入搜索关键词" @clear="clearInput"
            @search="onSearch">
            <template #action>
              <div @click="onSearch">
                搜索
        ...
        <div class="box-border">
          <van-dropdown-menu ref="menuRef">
            <van-dropdown-item ref="addressRef" v-model="location" @change="changeAddress" :options="allAddressOptions"
              :title="qu">
              <!-- <van-cascader
            ...
            <van-dropdown-item ref="classRef" :title="ke">
              <van-cascader v-model="cascaderValue" title="请选择课程类型" :options="allOptions" @close="closeClass"
                @finish="onFinish" />
            </van-dropdown-item>
            <van-dropdown-item ref="itemRef" :title="timeDay">
              <div class="day-box">
                <div v-for="item in dayOptions" class="day-item"
            ...
            <van-dropdown-item ref="typeRef" :title="type" @change="changeClass">
              <van-cascader v-model="typeValue" title="请选择类型" :options="classOptions" @close="closeType"
                @finish="onFinishType" />
            </van-dropdown-item>
          </van-dropdown-menu>
        </div>
        ...
        <div v-if="searchList.length > 0" class="search-list" @wheel.stop @touchmove.stop>
          <div v-for="item in searchList" :key="item.title" class="search-item" @click="clickSearchValue(item.title)"
